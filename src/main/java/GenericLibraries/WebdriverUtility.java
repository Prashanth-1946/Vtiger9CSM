...
public class WebdriverUtility 
{
	...
	/**
	 * This is method is used to wait until element is visible
	 * @param element
	 * @param time
	 * @return
	 */
	...
	/**
	 * This method is used to select an element from the drop down based on index
	 * @param element
	 * @param index
	 */
	 ...
	 * @param element
	 */
	public void selectFromDropdown(String vtext,WebElement element)
	{
		Select select=new Select(element);
	...
	/**
	 * This method is used to get the patent window address
	 * @return
	 */
	...
	/**
	 * This method is used to convert String to dynamic x path
	 * @param commonPath
	 * @param replaceData
	 * @return
	 */
